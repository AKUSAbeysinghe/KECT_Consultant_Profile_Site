      ...
      <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row justify-center text-center md:text-left divide-y md:divide-y-0 md:divide-x divide-gray-700">
        ...
        <div className="md:w-1/3 px-4 pb-6 md:pb-0">
          ...
          <p className="text-sm text-gray-300">
            Professional ISO and management consultation service delivering excellence since 2009.
          </p>
        ...
        <div className="md:w-1/3 px-6 py-6 md:py-0">
          ...
          <ul className="grid grid-cols-2 gap-x-4 text-sm text-gray-300">
            ...
            <li><Link to="/fssc22000Main" className="hover:text-white">FSSC Certification</Link></li>
            <li><Link to="/administration" className="hover:text-white">Administration Services</Link></li>
            {/* <li><Link to="/hr" className="hover:text-white">HR Consulting Services</Link></li> */}
            
            <li><Link to="/mrm" className="hover:text-white">Internal Audit and MRM Consultation </Link></li>
            <li><Link to="/hr" className="hover:text-white">HR Consulting Services</Link></li>
            <li><Link to="/inventory" className="hover:text-white">Inventory Management Services</Link></li>
