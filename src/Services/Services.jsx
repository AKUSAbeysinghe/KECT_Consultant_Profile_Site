...
// import MSbgI from "../assets/MSbgI.webp";
// import FSSCImage from "../assets/22000bgI.webp";
...
//     subtitle: "Operational & Business Consulting",
//     image: MSbgI,
//     route: "/additional-services",
//     description:
//       "Strategic consulting in Inventory, Review Meetings, Administration, and HR to streamline operations, optimize resources, and align business functions with modern management practices.",
//   },
//   {
//     title: "FSSC 22000",
...
//     route: "/fssc22000Main",
//     description:
//       "Guidance on implementing FSSC 22000 to meet global food safety requirements, including ISO 22000, PRPs, and regulatory compliance tailored to food sector needs.",
//   },
// ];
...
//           maintaining certifications in areas such as quality, environmental, health and safety, food safety, laboratories and hospitals, energy management and information security. Our expertise in healthcare, manufacturing, laboratories and hospitals, hospitality industry and various providers will guide them in implementation, internal audits, and regulatory readiness for ISO standard requirements. We
//           also support best practices like <b>GMP, Organic and BRCGS</b> to enhance
    ...
    >
      <div className="py-2 max-w-7xl mx-auto text-left">
        ...
        >
          ...
          health and safety, food safety, laboratories and hospitals, energy
          management and information security. Our expertise in healthcare,
          manufacturing, laboratories and hospitals, hospitality industry and
          various providers will guide them in implementation, internal audits,
          and regulatory readiness for ISO standard requirements. We also
          support best practices like <b>GMP, Organic and BRCGS</b> to enhance
          quality and global compliance.
        </Typography>

        {/* Cards – 3-col top, 2-col bottom centered under gaps */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <Box
            sx={{
              ...
              display: "grid",
              gap: "24px",
              // 6-column base grid (3 for top row, 2 for bottom row + empty slots)
              gridTemplateColumns: {
                xs: "1fr",
                sm: "repeat(4, 1fr)",
                md: "repeat(6, 1fr)",
