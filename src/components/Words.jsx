      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center relative z-10">
          ...
          <div className="space-y-6 text-left px-4 sm:px-0 max-w-xl mx-auto lg:mx-0">
            ...
            >
              <p>
                Mr. Vinod Kumar Khandelwal is a respected leader and the founder of KECT Group of Companies. Born in Mumbai in 1941, he studied Mathematics in USA and earned his MBA from the Bajaj Institute of Management in India.
              </p>
              <p>
                He began his global career in India in 1962 and has worked across India, the Middle East, and Sri Lanka for over 40 years. His portfolio includes major achievements like the tallest residential building in Asia and key infrastructure developments in the Gulf.
              </p>
              <p>
