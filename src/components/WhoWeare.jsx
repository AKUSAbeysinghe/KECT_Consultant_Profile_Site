...
const points = [
  ...
  { text: "150+ reputed clients across Sri Lanka and internationally.", icon: <Users size={28} className="text-indigo-600" /> },
        ...
        <div className="flex flex-col justify-center text-center md:text-left">
          <div className="bg-white/60 backdrop-blur-sm p-8 sm:p-10 rounded-xl shadow-lg border border-gray-200">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed">
              Expert Consultation for obtain certification with guaranteed success, flexible pricing,
